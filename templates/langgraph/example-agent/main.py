"""
Example LangGraph Agent with FYY CLI integration.

This example demonstrates how to build a LangGraph agent that leverages
...
def main() -> None:
    ...
    print("Edit main.py to build your own LangGraph agent.")
